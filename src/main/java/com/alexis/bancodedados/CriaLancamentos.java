...
public class CriaLancamentos {
	public static void main(String[] args) {
		...
		LocalDate dataVencimento1 = LocalDate.now();
		dataVencimento1 = LocalDate.of(2013, 10, 1);
		LocalDate dataVencimento2 = LocalDate.now();
		dataVencimento2 = LocalDate.of(2013, 12, 10);
		...
		lancamento3.setDataVencimento(dataVencimento2);
